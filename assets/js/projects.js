...
$(document).ready(function() {
    ...
    const projects = [
        ...
        {'anchorTag': 'moviesApp', 'title': 'Movies Application', 'description': 'A java application that uses recursive methods, loops, and JSON files to CRUD data.', 'gifSrc': 'https://giphy.com/embed/2YjYpOl1eBy6I', 'url': '', 'codeSrc': 'https://github.com/kyla-joaquin/movies-application'},
