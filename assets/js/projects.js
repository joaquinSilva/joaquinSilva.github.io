...
$(document).ready(function() {
    ...
    const projects = [
        {'anchorTag': 'curiosities', 'title': "Cody's Curiosities", 'description': 'A craigslist - type java application that uses jsp files, servlets, and DAOs (data access objects) to allow users to create, read, update, and delete ads from a MySQL database. ', 'gifSrc': 'https://giphy.com/embed/2YjYpOl1eBy6I', 'url': 'https://www.google.com/', 'codeSrc': 'https://github.com/XanaduLister/java-adlister'},
        {'anchorTag': 'contactsManager', 'title': 'Contacts Manager', 'description': 'A java application that uses conditional logic and loops to temporarily store data and respond to user input.', 'gifSrc': 'https://giphy.com/embed/2YjYpOl1eBy6I', 'url': 'https://www.google.com/', 'codeSrc': 'https://github.com/joaquin-juan/contacts-manager'},
        {'anchorTag': 'moviesApp', 'title': 'Movies Application', 'description': 'A java application that uses recursive methods, loops, and JSON files to CRUD data.', 'gifSrc': 'https://giphy.com/embed/2YjYpOl1eBy6I', 'url': 'https://www.google.com/', 'codeSrc': 'https://github.com/kyla-joaquin/movies-application'},
        ...
        {'anchorTag': 'coffee', 'title': 'Coffee Project', 'description': 'A front end application that uses DOM manipulation and javascript to dynamically render items based on a search bar input.', 'gifSrc': 'https://giphy.com/embed/2YjYpOl1eBy6I', 'url': 'https://www.google.com/', 'codeSrc': 'https://github.com/stuart-joaquin/coffee-project'},
        {'anchorTag': 'codeup', 'title': 'Codeup Design', 'description': 'Exposure to front-end web design and responsive design concepts for different screen sizes utilizing bootstrap framework technology.', 'gifSrc': 'https://giphy.com/embed/clofJvzgEU1YogbyHF', 'url': 'https://www.google.com/', 'codeSrc': 'https://github.com/steven-joaquin/codeup-design'}
    ];
